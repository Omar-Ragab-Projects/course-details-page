...
function AddCommentForm() {
  ...
  const addCommentAction = async (e: FormEvent) => {
    e.preventDefault();
  ...
  return (
    <form
      ...
      className="p-4 bg-gray-100/90 min-w-[90%]"
    >
      <textarea
        name=""
        id=""
      ...
      <button className="flex-center gap-2 bg-[#41b69d] hover:bg-[#33a58c] text-white px-8 py-4 mt-4 rounded-md text-sm cursor-pointer ">
